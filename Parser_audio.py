...
def wavSegmentationFromSubs(relPath, subtitles, repo_path, audio_cnt):
    ...
    print('Done splitting wav file ' + audio_name + '. Audio had ' + str(countpos) + ' positive segments, ' + str(
        countneg) + " negative segments and " + str(countneu) + "neutral segments. ")
...
def main(argv):
    ...
    aT.featureAndTrain([repo_path + "/audio/positive", repo_path + "/audio/neutral", repo_path + "/audio/negative"],
                       1.0, 1.0, aT.shortTermWindow, aT.shortTermStep, "svm", "svm5Classes")
